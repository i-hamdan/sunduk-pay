    ...
    public void sendFallbackTransactionEmail(final TransactionEvent event) {
        try {
            ...
            String body = "Dear "
                    ...
                    : "User")
                    + ",\n\n"
                    + "We attempted to notify you via SMS regarding your recent "
                    + "transaction, but the SMS delivery failed. To ensure you stay "
                    + "informed, we are providing the full transaction details below:\n\n"
                    + " Transaction Summary:\n"
                    ...
                    : "N/A")
                    + "\n\n"
                    + " Status: The transaction has been successfully processed in "
                    + "our system.\n\n"
                    + " Note: This email is being sent as a fallback because the SMS "
                    + "alert could not be delivered. You can safely rely on this email "
                    + "for your transaction record.\n\n"
                    + "For any questions or if you notice discrepancies, please reach "
