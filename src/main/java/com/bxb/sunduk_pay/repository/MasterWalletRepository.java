 ...
 * {@link MasterWallet} documents stored in MongoDB.
 * <p>
 * Provides methods to retrieve the master wallet associated
...
public interface MasterWalletRepository extends MongoRepository<MasterWallet, String> {
     ...
     * @return an {@link Optional} containing the {@link MasterWallet}
     *         if found, or an empty Optional if no wallet exists
     *         for the given user
     */
    @SuppressWarnings("checkstyle:MethodName")
    Optional<MasterWallet> findByUser_Uuid(final String uuid);
}
