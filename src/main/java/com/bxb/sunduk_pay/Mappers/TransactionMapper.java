...
/**
 * Mapper interface for converting Transaction entities
...
public interface TransactionMapper {
    ...
    /**
     * Converts a list of Transaction entities to a list of
    ...
    /**
     * Converts a Transaction entity to a TransactionEvent
